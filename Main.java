...
//tworzenie dwoch obiektow klasy ksiazka
    ...
    Czytelnik c1 = new Czytelnik("Patrycja", "Pietraszek");
...
/*
 * Zadania:
 * 1. Stworz wlasna klase Czytelnik (z atrybutami: imie oraz nazwisko). -> zrobione
 * 2. Otworz do zapisu kolejny plik (np. czytelnicy.txt). -> zrobione
 * 3. Zapisz do niego 2 obiekty klasy Czytelnik. -> zrobione
